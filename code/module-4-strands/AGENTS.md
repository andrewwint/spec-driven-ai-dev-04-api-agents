...
> For skill files using AgentSkills.io format, see `skills/*/SKILL.md`
> For legacy agent definitions, see `.github/agents/*.agent.md`
...
| Agent / Skill | Type | Role | Tools | Model Tier |
|-------|------|------|-------|------------|
...
Each agent above has a corresponding skill file in `skills/<name>/SKILL.md` following the AgentSkills.io format.
